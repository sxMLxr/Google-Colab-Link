...
def pred_5fold(MSS_positive, MSS_negative, opts):
	...
	for i in range(opts.num_folds):
		...
		trp, tsp, tsp_prob = classifier.learn_classifier(opts.classifier, train_binary_matrix, train_labels, test_binary_matrix, test_labels)
		print (len(tsp))
	...
	roc_auc = auc(fpr, tpr)
	return accuracy, precision, recall, f_measure, roc_auc, 0, 0, 0, 0
